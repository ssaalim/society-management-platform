...
function ActivityRow({ item }: { item: ActivityItem }) {
  const statusColors: Record<string, string> = {
    ...
    CLOSED: 'bg-slate-100 text-slate-600 border-slate-300 dark:bg-slate-800/30 dark:text-slate-400 dark:border-slate-700/50',
  ...
  const renderTreasurerDashboard = () => (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-xl border border-slate-800 bg-slate-950/20 p-5 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Recent Bills</h3>
