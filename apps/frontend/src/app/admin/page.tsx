...
export default function SuperAdminConsolePage() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-start overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
      {/* Background Grids */}
      ...
      <div className="w-full max-w-6xl z-10 space-y-8 bg-slate-900/30 border border-slate-800 p-8 rounded-2xl backdrop-blur-xl">
