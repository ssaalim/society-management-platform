...
import { Building, UploadCloud, CheckCircle, FileText, Loader2, AlertCircle, ArrowLeft, Users, ShieldAlert, History, CreditCard, Plus, Trash2, Home, Key , X } from 'lucide-react';
...
export default function MemberDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'family' | 'nominees' | 'flats' | 'idcard'>('profile');
            ...
            {activeTab === 'profile' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label className="text-xs text-slate-500 dark:text-slate-400 font-medium">Membership Number</label>
                    <input
                  ...
                  <div>
                    <label className="text-xs text-slate-500 dark:text-slate-400 font-medium">Member Category</label>
                    <select
                      {...register('memberType')}
