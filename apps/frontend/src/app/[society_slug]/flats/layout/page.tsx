      ...
      <div className="w-full max-w-4xl z-10 space-y-8 bg-slate-900/30 border border-slate-800 p-8 rounded-2xl backdrop-blur-xl">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-800 pb-5">
          <div className="flex items-center gap-3">
            <Link href={`/${society_slug}/flats`} className="p-2 rounded-full hover:bg-slate-800 transition-colors">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Manage society buildings, wings, and floors.</p>
            </div>
          </div>
          <button
            onClick={handleAddBuilding}
            className="flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-900/20 hover:bg-indigo-500 hover:scale-[1.02] transition-all"
          >
